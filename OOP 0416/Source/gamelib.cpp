...
: NUM_GAME_STATES(6)
{
	...
	gameStateTable[GAME_STATE_2] = new CGameState2(this);
	gameStateTable[GAME_STATE_DEAD] = new CGameStateDead(this);
	gameStateTable[GAME_STATE_ABOUT] = new CGameStateAbout(this);
	gameStateTable[GAME_STATE_CONFIGURATION] = new CGameStateConfiguration(this);
